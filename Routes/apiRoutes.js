...
module.exports = function(app) {
    ...
    app.get("/api/notes", (req,res) => {
        ...
        response.json(data); //This line sends the read data from the database to the response of the GET request
    });
    //POST request
    ...
    app.delete("/api/notes/:id", (req,res) => {
        ...
        response.json(newData);//send response
